  ...
  en: {
    ...
    projects: [
      ...
      },
      {
        ...
        description: 'Multi-location ordering system integrating 6+ third-party services.',
        details: 'Payment tokenization, loyalty rewards API, headless CMS, third-party ordering system, Google Maps. Built data translation layer between systems with different formats and auth methods. Sole frontend developer.',
  ...
  pl: {
    ...
    projects: [
      ...
      },
      {
        ...
        description: 'System zamówień wielolokalizacyjny integrujący 6+ zewnętrznych serwisów.',
        details: 'Tokenizacja płatności, API lojalnościowe, headless CMS, zewnętrzny system zamówień, Google Maps. Warstwa translacji danych między systemami z różnymi formatami i metodami autoryzacji. Jedyny frontend developer.',
        stack: 'Next.js · TypeScript · Tailwind · React Query · Chart.js',
      },
    ],
    contact: 'Kontakt',
  ...
  uk: {
    ...
    projects: [
      ...
      },
      {
        ...
        description: 'Мережа ресторанів з інтеграцією 6+ зовнішніх сервісів.',
        details: 'Токенізація платежів, API лояльності, headless CMS, зовнішня система замовлень, Google Maps. Шар трансляції даних між системами з різними форматами та методами авторизації. Єдиний frontend-розробник.',
        stack: 'Next.js · TypeScript · Tailwind · React Query · Chart.js',
      },
    ],
    contact: 'Контакт',
  ...
  ru: {
    ...
    projects: [
      ...
      },
      {
        ...
        description: 'Сеть ресторанов с интеграцией 6+ внешних сервисов.',
        details: 'Токенизация платежей, API лояльности, headless CMS, внешняя система заказов, Google Maps. Слой трансляции данных между системами с разными форматами и методами авторизации. Единственный frontend разработчик.',
        stack: 'Next.js · TypeScript · Tailwind · React Query · Chart.js',
      },
    ],
    contact: 'Связаться',
